...
// 							console.log("placeno :"+placeno)
				...
				$("#inputOrder").on('click', function() {
					...
					for(var i = 1; i<$("#order_detail").children().size();i++){
						...
						console.log(no);
						productNo.push(no)
						var opNo =$("#order_detail").children("div").eq(i).children("div").eq(2).children("input").eq(0).val();
						console.log(opNo);
						if (opNo==""){
							optionList.push(0);
						}else{
							optionList.push(opNo*1)
						}
						productcnt.push($("#order_detail").children("div").eq(i).children("div").eq(3).children("input").eq(0).val()*1)
